...
<header id="mu-hero">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light mu-navbar">
            ...
            <!-- image based logo -->
            <!-- <a class="navbar-brand mu-logo" href="index.html"><img src="{{asset("frontend/assets/images/")}}logo.png" alt="logo"></a> -->
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mu-single-footer">
                        <img class="mu-footer-logo" src="{{asset("frontend/assets/images/")}}logo.png" alt="logo">
...
<script type="text/javascript" src="{{asset("assets/frontend/js/jquery.filterizr.min.js")}}"></script>
<!-- Gallery Lightbox -->
