                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <div class="input-group-btn">
                                        <button id="newSetting" class="btn btn-primary">Ekle</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push("customJs")
    <script>
        ...
        $("#newSetting").click(function(){
            var data = "<tr>\n" +
                "<td><input class=\"form-control\" type=\"text\" value=\"\" name=\"key\" id=\"newSettingKey\" /> </td>\n" +
                "<td><input class=\"form-control\" type=\"text\" value=\"\" name=\"value\" id=\"newSettingValue\" /> </td>\n" +
                "</tr>";
